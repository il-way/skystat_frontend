      ...
      <Topbar
        ...
        rightSlot={
          <div className="w-full lg:w-36 lg:shrink-0">
            <label className="mb-1 block whitespace-nowrap text-xs text-slate-600">{t("analysis.filters.visibilityThreshold")}</label>
            <input
              type="number"
              min={0}
              max={9999}
      ...
      <main className="bg-slate-50">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/80 p-4 shadow-sm">
          ...
          <ul className="list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
            <li>{t("analysis.guide.visibility.1")}</li>
        ...
        <AdSlot slotKey="visibility_bottom" minHeight={260} />
